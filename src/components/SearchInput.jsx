...
export default function SearchInput({ categories, handleFilter, inputHandler, busqueda}) {
  return (
    <div>
    ...
    <div className="nameDiv" >
        ...
        />
        <button className="bg-purple-800 p-2  rounded" onClick={() => inputHandler}>Buscar</button>
